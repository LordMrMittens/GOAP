...
public class GOAPUI : MonoBehaviour
{
    ...
    public void UpdateGoal(MonoBehaviour goal, string _name, string _status, float _priority, string _givenName = "")
    {
        string name = "";
        ...
        DisplayedGoals[goal].UpdateGoalInfo(name, _status, _priority);
    }
}
